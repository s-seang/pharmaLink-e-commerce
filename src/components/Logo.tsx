 ...
 *     the logo has to carry the brand by itself (footer).
 *
 * Both files are opaque PNGs with a white background, so `full` in particular
 * needs a light surface behind it — the footer wraps it in a white pill.
 *
